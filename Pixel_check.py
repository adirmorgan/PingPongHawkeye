...
class NpyVideoClickViewer:
    def __init__(self, root: tk.Tk) -> None:
        ...
        self.clicked_points = {}  # frame_index -> list of (x, y, label_text)
    ...
    def on_click(self, event: tk.Event) -> None:
        ...
        self.clicked_points[self.current_frame_index].append((x, y, label_text))
        self.update_frame_display()

        self.info_label.config(
            text=f"Clicked pixel: frame={self.current_frame_index}, x={x}, y={y}"
        )
